...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 pb-40 md:pb-24 mt-4 space-y-16 animate-fade-in-up relative z-10 safe-bottom">
      ...
      <div className="mb-10 flex justify-center border-t border-warm-gray-200/30 pt-8 dark:border-warm-gray-800/30 sm:mb-0">
        <button
