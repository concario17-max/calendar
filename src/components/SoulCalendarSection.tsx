    ...
    <section className="relative animate-fade-in-up stagger-2 pb-2 md:pb-4">
      <div className="mb-8 md:mb-9">
        <div className="group space-y-3 text-center">
          <h2 className="text-center text-[1.9rem] font-brand font-semibold leading-[0.98] tracking-[0.01em] text-transparent bg-clip-text bg-gradient-to-b from-warm-gray-800 to-warm-gray-500 transition-transform duration-500 group-hover:translate-x-0.5 dark:from-white dark:to-warm-gray-400 md:text-[2.3rem]">
