...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="ui-surface--raised archive-header sticky top-0 z-30 flex min-h-[4rem] w-full flex-col gap-2.5 border-0 bg-transparent px-4 py-3 text-on-surface sm:flex-row sm:items-center sm:gap-2 sm:px-4 sm:py-2.5 lg:px-8">
