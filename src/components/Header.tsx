...
export const Header: React.FC<HeaderProps> = ({ selectedDate, onDateChange }) => {
  ...
  return (
    <div className="fixed top-2 right-2 sm:top-3 sm:right-3 z-50 flex items-center gap-1 rounded-full border border-warm-gray-200/50 bg-white/65 px-1.5 py-1 shadow-sm shadow-warm-gray-300/20 backdrop-blur-md transition-colors duration-300 dark:border-warm-gray-700/40 dark:bg-ray-dark/65 dark:shadow-black/20">
