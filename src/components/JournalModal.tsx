...
export const JournalModal: React.FC<JournalModalProps> = ({ isOpen, onClose, selectedDate, yaoTitle }) => {
  ...
  const handleSave = () => {
    ...
    // In a real app we might use a global toast context, but window.alert or custom event is fine
    const toastEvent = new CustomEvent('show-toast', { detail: '성공적으로 저장되었습니다' });
